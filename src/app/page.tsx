  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#06110d] text-white">
      <section className="relative isolate">
        ...
        />
        <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(3,10,7,0.82)_0%,rgba(3,10,7,0.58)_42%,rgba(3,10,7,0.24)_100%),linear-gradient(180deg,rgba(3,10,7,0.08)_0%,rgba(6,17,13,0.44)_68%,#06110d_100%)]" />
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(132,204,22,0.16),transparent_30%),radial-gradient(circle_at_78%_24%,rgba(20,184,166,0.08),transparent_28%)]" />
